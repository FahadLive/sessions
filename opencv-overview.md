...
description: Two-session workshop where you turn your webcam into an air pencil — track your index fingertip with MediaPipe and draw on screen by pointing at it.
eleventyNavigation:
...
| Page                              | What it covers                         |
| --------------------------------- | -------------------------------------- |
| [Setup](/opencv-setup/)           | Install uv, Python, and the libraries  |
